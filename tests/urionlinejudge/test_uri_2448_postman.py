...
RESOURCES_PATH = './tests/urionlinejudge/resources/2448'
EXECUTABLE_PATH = './problems/urionlinejudge/uri_2448_postman.py'
...
def test_uri_2448_postman(input_path: str, output_path: str):
